      ...
      <main className="flex justify-center items-center h-screen">
        <div className="w-11/12 h-5/6 border-4 border-primary bg-primary rounded-3xl flex">
          ...
          <div className="flex flex-col grow px-8 py-5">
            ...
            <div className="bg-white flex flex-col justify-center grow rounded-3xl px-4 py-2">
              <div className="w-32 self-center">
                ...
                <Button
                  ...
                  disabled={
                    ...
                    queue?.nurse.length === undefined
                  }
                >
                  Examine {queue?.nurse[0]?.idNumber}
                </Button>
              </div>
              ...
              <Button disabled={name === ""}>Proceed</Button> */}
            </div>
          </div>
        </div>
      </main>
